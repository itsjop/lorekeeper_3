...
class Feature extends Model {
  ...
  public function getTwolineDisplayNameAttribute() {
    return '<a href="' . $this->url . '" class="display-trait">' . $this->name . '</a>'
      . ($this->rarity ? '<span>' . $this->rarity->displayName . '</span>' : '');
  }
  public function getTitleAttribute() {
    return '<a href="' . $this->url . '" class="display-trait">' . $this->name . '</a>';
  }
  public function getRarityNameAttribute() {
    return isset($this->rarity) ? ($this->rarity ? '' . $this->rarity->displayName . '' : '') : '';
  }
