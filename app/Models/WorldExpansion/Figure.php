...
class Figure extends Model {
  ...
  public function getDisplayNameAttribute() {
    if ($this->is_active) {
      ...
      return '<s>
<a href="' . $this->url . '" class="display-figure text-muted">' . $this->name . '</a></s>';
    }
  }
  ...
  public function getFullDisplayNameAttribute() {
    if ($this->is_active) {
      ...
      return '<s>
<a href="' . $this->url . '" class="display-figure text-muted">' . $this->style . '</a></s>';
    }
  }
  ...
  public function getFullDisplayNameUCAttribute() {
    if ($this->is_active) {
      ...
      return '<s>
<a href="' . $this->url . '" class="display-figure text-muted">' . ucfirst($this->style) . '</a></s>';
    }
  }
