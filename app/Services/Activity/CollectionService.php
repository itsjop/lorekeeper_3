...
class CollectionService extends Service {
    ...
    public function act($activity, $data, $user) {
        ...
        try {
            ...
            if (!$isComplete) {
                throw new \Exception('You haven\'t completed this Collection.');
            }
            ...
            if (!$rewards = fillUserAssets($collection->rewardItems, null, $user, $logType, $rewardData)) {
            ...
            if (!(new CollectionManager)->creditCollection(null, $user, null, 'Collection Completed', $collectionData, $collection)) {
                throw new \Exception('Failed to create collection log.');
            }
