...
<img src="{{ $prompt->imageUrl }}" class="world-entry-image" alt="{{ $prompt->name }}" /></a></div>
    @endif
...
<i class="fas fa-search"></i></a></h1>
            @else
                <h2 class="mb-0">
<a href="{{ $prompt->idUrl }}">{!! $prompt->name !!}</a></h2>
            @endif
        ...
        <div class="world-entry-text">
            <p>{{ $prompt->summary }}</p>
            <h3 class="mb-3">
<a data-toggle="collapse" href="#prompt-{{ $prompt->id }}" @if (isset($isPage)) aria-expanded="true" @endif>Details <i class="fas fa-angle-down"></i></a></h3>
