...
@section('content')
  ...
  <div class="extensions row no-gutters">
    ...
    <p class="mb-0 col-md-4">
      ...
      <a href="https://github.com/redcr0wz">Lexi</a>, <a href="https://github.com/SpeedyD">Speedy</a>, <a
        href="https://github.com/ScuffedNewt"
      >ScuffedNewt</a>, & <a href="https://github.com/itinerare">itinerare</a>
    </p>
    <p class="mb-0 col-md-4">
      ...
      </a> by <a href="https://github.com/preimpression">Preimpression</a> & <a
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Galleries">
        <strong>
          Galleries
        </strong>
      </a> by <a href="https://github.com/itinerare">itinerare</a>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Autopopulate_New_Image_Traits">
        <strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Captcha">
        <strong>
          Captcha
        </strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Character_Prev_and_Next">
        <strong>
          Character Prev and
          Next
        </strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Character_Rewards">
        <strong>
          Character Rewards
        </strong>
      </a> by <a href="https://github.com/preimpression">Preimpression</a>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Character_Status_Badges">
        <strong>
          Character Status
          Badges
        </strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Character_TH_Profile_Link">
        <strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Collapsible_Admin_Sidebar">
        <strong>
          Collapsible Admin
          Sidebar
        </strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Design_Update_Voting">
        <strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Gravatar">
        <strong>
          Gravatar
        </strong>
      </a> by <a href="https://github.com/ScuffedNewt">ScuffedNewt</a>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Group_Traits_by_Category">
        <strong>
          Group Traits by
          Category
        </strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Item_Entry_Expansion">
        <strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:MYO_Image_Removal">
        <strong>
          MYO Image Removal
        </strong>
      </a> by <a href="https://github.com/itinerare">itinerare</a>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Navbar_News_Notif">
        <strong>
          Navbar News Notif
        </strong>
      </a> by <a href="https://github.com/junijwi">Junijwi</a>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Organised_Traits_Dropdown">
        <strong>
          Organised Traits
          Dropdown
        </strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Scroll_To_Top">
        <strong>
          Scroll to Top
        </strong>
      </a> by <a href="https://github.com/preimpression">Preimpression</a>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Gallery_Recent_Submissions">
        <strong>
          Show All Recent
          Submissions
        </strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Species_Trait_Index">
        <strong>
          Species Trait Index
        </strong>
      </a>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Subtype_Trait_Index">
        <strong>
          Subtype Trait Index
        </strong>
      </a>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Staff_Rewards">
        <strong>
          Staff Rewards
        </strong>
      </a> by <a href="https://github.com/itinerare">itinerare</a>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Universal_Trait_Index">
        <strong>
          Universal Trait
          Index
        </strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:User_Character_Minibadges">
        <strong>
          User Character
          Minibadges
        </strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:VTI_Trait_Modals">
        <strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Watermarking">
        <strong>
          Watermarking
        </strong>
      </a> by <a href="https://github.com/itinerare">itinerare</a>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:Watermarking_Image_Automation">
        <strong>
          Watermarking - Image
          Automation
        </strong>
    ...
    <p class="mb-0 col-md-4">
      <a href="http://wiki.lorekeeper.me/index.php?title=Extensions:90_Percent_Watermark">
        <strong>
          Watermark Resizing
        </strong>
      </a>
