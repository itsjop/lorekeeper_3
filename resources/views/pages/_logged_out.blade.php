  ...
  <div class="card-basic">
    ...
    <div class="card-text">
      <p> Similar to their vampire ancestors, somnivores possess the ability to shapeshift from their bat form into a humanoid -
        this
        is referred to as their demon form. <br /> These demons often sport unnatural skin tones and always maintain their horns
        and
  ...
  <div class="card-basic">
    ...
    <div class="card-text">
      ...
      <p> Reverie is the magical realm in which the vast majority of the somnivore population resides. Founded by the first colony
        ...
        <br /> A lot of things we're familiar with in our everyday lives have a counterpart that exists in Reverie- though through
        a
        bit of a "dream-like" lens. Plants glow, clouds can be built on, the breeze carries stardust. Buildings and technology can
        almost appear cartoonish with their soft shapes and glowing parts. There&rsquo;s no shortage of mystical places to visit
        and
        interesting things to do! <br /> In a thriving age of abundant dreams, somnivores value community, leisure, and curiosity
        for
        the expanding whimsical world they reside in.
      </p>
    </div>
  </div>
