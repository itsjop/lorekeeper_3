@extends('character.design.layout', ['componentName' => 'character/design/request'])
      ...
      @elseif($request->status == 'Pending')
        <p>
          ...
          @if (!Auth::user()->hasPower('manage_characters'))
            ...
            @endif
          @else
            As a staff member with the ability to edit the masterlist, you can view the details of the request, but can only edit
            certain parts of it.
          @endif
        </p>
        @if (Auth::user()->hasPower('manage_characters'))
