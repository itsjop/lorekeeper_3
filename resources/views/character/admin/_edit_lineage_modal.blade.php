...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('father_name', 'Father Name') !!} {!! add_help('If the father is known, leave this blank.') !!}
...
<div class="row">
    ...
    <div class="col-md-6">
        {!! Form::label('mother_name', 'Mother Name') !!} {!! add_help('If the mother is known, leave this blank.') !!}
