@extends('character.layout', ['componentName' => 'character/update-form', 'isMyo' => $character->is_myo_slot])
...
@section('profile-content')
  ...
  @if (!$queueOpen)
    <div class="alert alert-danger">
      The {{ $character->is_myo_slot ? 'MYO approval' : 'design update' }} queue is currently closed. You cannot submit a new
  ...
  @elseif(!$request)
    ...
    <p> This will prepare a request to approve
      ...
      view the draft and provide feedback. </p>
    {!! Form::open([
        'url' => $character->is_myo_slot ? 'myo/' . $character->id . '/approval' : 'character/' . $character->slug . '/approval'
    ]) !!}
