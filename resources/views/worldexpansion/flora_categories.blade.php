@extends('worldexpansion.layout', ['componentName' => 'worldexpansion/flora-categories'])
        ...
        <div class="card mb-3 p-3 h-100">
          <div class="world-entry-image">
            @isset($category->thumb_extension)
              ...
              >
                <img src="{{ $category->thumbUrl }}" class="world-entry-image hover-preview mb-3 mw-100" />
              </a>
            @endisset
          </div>
          <h3>
