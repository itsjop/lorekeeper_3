      ...
      <div class="card-header" id="headingTwo">
        <div class="row p-2">
          ...
          @if (!$form->is_anonymous && $question->has_options && $user && $user->isStaff)
            <a
              href="#"
              class="ml-2 collapsed collapse-toggle"
              type="button"
        ...
        @if ($question->options->count() > 0)
          @foreach ($question->options as $option)
            ...
            <div class="progress" style="height: 30px;">
              <div
                class="progress-bar @if ($totalAnswers > 0 && ($optionAnswers / $totalAnswers) * 100 == 0) ml-2 text-dark @endif"
                role="progressbar"
                style="width:{{ $totalAnswers > 0 ? ($optionAnswers / $totalAnswers) * 100 : 0 }}%;"
