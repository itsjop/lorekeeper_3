<div class="card-header">
  ...
  <div class="h6">
    <b>
      @if ($form->is_timed && isset($form->end_at) && $form->end_at < Carbon\Carbon::now())
        [CLOSED]
      @else
        [OPEN]
      @endif
    ...
    @if ($form->is_timed)
      Open @if ($form->startDate)
        from {!! format_date($form->startDate) !!}
        @endif @if ($form->endDate)
          until {!! format_date($form->endDate) !!}
        @endif
      @endif
  </div>
  <div class="h5">
