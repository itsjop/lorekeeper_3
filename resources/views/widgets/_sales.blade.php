                ...
                <div class="row {{ !$loop->last ? 'border-bottom' : '' }} py-3 align-items-center">
                    @if ($sales->characters->count())
                        <div class="col-md-3 text-center">
                            <a href="{{ $sales->url }}">
                                <img src="{{ $sales->characters->first()->character->image->thumbnailUrl }}" alt="{!! $sales->characters->first()->character->fullName !!}" class="img-thumbnail mb-1" />
                            </a>
                        </div>
                    @endif

                    <div class="{{ $sales->characters->count() ? 'col-md-9' : 'col-12' }}">
