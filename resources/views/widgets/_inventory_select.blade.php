...
@endif
<div class="{{ isset($hideCollapse) && isset($selected) && count($selected) ? '' : 'collapse' }}" id="userInventory">
  <div class="card mb-3">
    <div class="card-body">
          ...
          <tbody>
            @foreach ($inventory as $itemRow)
              ...
              <td class="col-1">{!! Form::checkbox(
                  ...
                  $itemRow->id,
                  isset($selected) && in_array($itemRow->id, array_keys($selected)) ? true : false,
              ...
              <td class="col-4">
                {!! array_key_exists('data', safeJSON($itemRow->data)) ? (safeJSON($itemRow->data)['data'] ? safeJSON($itemRow->data)['data'] : 'N/A') : 'N/A' !!}
              </td>
              <td class="col-3">
                {!! array_key_exists('notes', safeJSON($itemRow->data)) ? (safeJSON($itemRow->data)['notes'] ? safeJSON($itemRow->data)['notes'] : 'N/A') : 'N/A' !!}
              </td>
