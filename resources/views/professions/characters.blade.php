...
<div class="row">
    ...
    <div class="col-lg-5 col-12 text-lg-right text-center">
        <a href="/professions/{{ $category->id }}"><div class="btn btn-primary"><i class="fas fa-search"></i> View professions</div></a>
    </div>
</div>
...
@foreach($category->professionsBySubcategory as $subcategoryId => $professions)
    ...
    @isset($subcategory) <h3> {{ $subcategory->name }}</h3> @endisset
