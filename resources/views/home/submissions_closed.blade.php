@extends('home.layout', ['componentName' => 'home/submissions-closed'])
...
@section('home-content')
  ...
  @if (!$isClaim)
    <div class="form-group">
      ...
      {!! Form::select('prompt_id', $prompts, null, [
  ...
  <div class="form-group">
    ...
    @if ($isClaim)
      {!! add_help(
          'Enter a URL relevant to your claim (for example, a comment proving you may make this claim). This field cannot be left blank.'
      ) !!}
    @else
      {!! add_help(
          'Enter the URL of your submission (whether uploaded to dA or some other hosting service). This field cannot be left blank.'
      ) !!}
    @endif
