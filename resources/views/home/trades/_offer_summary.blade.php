      ...
      @foreach ($data['characters'] as $character)
        <div class="col-sm-3 col-4 mb-3">
          <div class="text-center inventory-item">
            <div class="mb-1">
              <a class="inventory-stack">
                <img src="{{ $character['asset']->image->thumbnailUrl }}" class="img-thumbnail" title="{{ $character['asset']->fullName }}" data-toggle="tooltip" alt="Thumbnail for {{ $character['asset']->fullName }}" /></a>
            </div>
          </div>
        </div>
      @endforeach
