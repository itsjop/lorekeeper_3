  ...
  <div class="tab-content" id="inboxTypeContent">
    ...
    >
      <p class="alert alert-info">
        This mail is anonymously sent messages from moderators.
        {{ config('lorekeeper.mod_mail.allow_replies_to_staff') ? 'You can respond to staff mail.' : 'It cannot be responded to.' }}
      </p>
      @if (count($modMail))
