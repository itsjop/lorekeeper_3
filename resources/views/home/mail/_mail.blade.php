<div class="mb-4 logs-table">
  <div class="logs-table-header">
    <div class="row">
      ...
      <div class="col-2 col-md-2">
        <div class="logs-table-cell"> To </div>
      </div>
      <div class="col-2 col-md-2">
        <div class="logs-table-cell"> At </div>
      </div>
        ...
        <div class="row flex-wrap">
          ...
          <div class="col-2 col-md-2">
            <div class="logs-table-cell at">
              {!! pretty_date($mail->created_at) !!}
            </div>
          </div>
          <div class="col-4 col-md-4">
            <div class="logs-table-cell message">
              <span class="ubt-texthide"> {{ Illuminate\Support\Str::limit(strip_tags($mail->message), 50, $end = '...') }}
              </span>
            </div>
          </div>
          <div class="col-1 col-md-1">
            <div class="logs-table-cell seen"> {!! $mail->seen ? '<i class="fas fa-check text-success"></i>' : '<i class="fas fa-times text-danger"></i>' !!} </div>
          </div>
          <div class="col-1 col-md-1">
            <div class="logs-table-cell details">
