<div id="sidebar-ul">
  ...
  <div class="details-sb" data-open>
    ...
    <div class="sb-item">
      <a href="{{ url('characters/myos') }}" class="{{ set_active('characters/myos') }}">
        My MYO Slots
      </a>
    </div>
    <div class="sb-item">
      <a href="{{ url('pets') }}" class="{{ set_active('pets*') }}">
        My Pets
      </a>
    </div>
    <div class="sb-item">
      <a href="{{ url('inventory') }}" class="{{ set_active('inventory*') }}">
        Inventory
      </a>
    </div>
    <div class="sb-item">
      <a href="{{ url(__('awards.awardcase')) }}" class="{{ set_active(__('awards.awardcase') . '*') }}">
        {{ __('awards.awardcase') }}
      </a>
    </div>
    <div class="sb-item">
      <a href="{{ url('bank') }}" class="{{ set_active('bank*') }}">
        Bank
      </a>
    </div>
  </div>
  <div class="details-sb" data-open>
    ...
    <div class="sb-item">
      <a href="{{ url('claims') }}" class="{{ set_active('claims*') }}">
        Claims
      </a>
    </div>
    <div class="sb-item">
    ...
    <div class="sb-item">
      <a href="{{ url('comments/liked') }}" class="{{ set_active('comments/liked*') }}">
        Liked Comments
      </a>
    </div>
  </div>
  <div class="details-sb" data-open>
    ...
    <div class="sb-item">
      <a href="{{ url('world/recipes') }}" class="{{ set_active('world/recipes') }}">
        All Recipes
      </a>
    </div>
    <div class="sb-item">
      <a href="{{ url('mail') }}" class="{{ set_active('mail*') }}">
        All Mail
      </a>
    </div>
  </div>
