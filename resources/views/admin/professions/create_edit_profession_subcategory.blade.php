...
@section('admin-title') Profession Subcategories @endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Profession Subcategories' => 'admin/data/profession-subcategories', ($subcategory->id ? 'Edit' : 'Create').' Subcategory' => $subcategory->id ? 'admin/data/profession-subcategories/edit/'.$subcategory->id : 'admin/data/profession-subcategories/create']) !!}
...
@if($subcategory->id)
    ...
    <div class="card mb-3">
        <div class="card-body">
            @include('world._entry', ['imageUrl' => $subcategory->imageUrl, 'name' => $subcategory->displayName, 'description' => $subcategory->parsed_description])
        </div>
    </div>
@endif
