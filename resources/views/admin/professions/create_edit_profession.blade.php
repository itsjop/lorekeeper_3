...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Professions' => 'admin/data/professions', ($profession->id ? 'Edit' :
'Create').' Profession' => $profession->id ? 'admin/data/professions/edit/'.$profession->id :
...
{!! Form::open(['url' => $profession->id ? 'admin/data/professions/edit/'.$profession->id :
'admin/data/professions/create', 'files' => true]) !!}
...
<div class="card mb-3">
    ...
    <div class="card-body row">
        <div class="form-group col-md-6">
            ...
            <a href="{{$profession->iconUrl}}" data-lightbox="entry" data-title="{{ $profession->name }}"><img
                    src="{{$profession->iconUrl}}" class="mw-100 float-left mr-3" style="max-height:125px"></a>
            @endif
            ...
            <div class="form-check">
                {!! Form::checkbox('remove_image_icon', 1, false, ['class' => 'form-check-input', 'data-toggle' =>
                'toggle', 'data-off' => 'Leave Icon As-Is', 'data-on' => 'Remove Icon Image']) !!}
            </div>
            @endif
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <a href="{{$profession->imageUrl}}" data-lightbox="entry" data-title="{{ $profession->name }}"><img
                    src="{{$profession->imageUrl}}" class="mw-100 float-left mr-3" style="max-height:125px"></a>
            @endif
            ...
            <div class="form-check">
                ...
                'data-off' => 'Leave Main Image As-Is', 'data-on' => 'Remove Current Main Image']) !!}
            </div>
            @endif
        </div>
    </div>
...
<div class="card mb-3">
    <div class="card-body">
        @include('world._entry', ['imageUrl' => $profession->imageUrl, 'name' => $profession->displayName, 'description'
