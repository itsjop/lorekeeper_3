...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Professions' => 'admin/data/professions', ($profession->id ? 'Edit' : 'Create').' Profession' => $profession->id ? 'admin/data/professions/edit/'.$profession->id : 'admin/data/professions/create']) !!}
...
$( document ).ready(function() {    
    $('.delete-profession-button').on('click', function(e) {
        e.preventDefault();
        loadModal("{{ url('admin/data/professions/delete') }}/{{ $profession->id }}", 'Delete Profession');
    });
});
