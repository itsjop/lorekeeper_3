...
@section('admin-title') Profession Categories @endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Profession Categories' => 'admin/data/profession-categories', ($category->id ? 'Edit' : 'Create').' Category' => $category->id ? 'admin/data/profession-categories/edit/'.$category->id : 'admin/data/profession-categories/create']) !!}
