    ...
    <div class="card">
      ...
      <div class="card-body collapse" id="required">
        <p>
          ...
          <br />
          To have a set range of traits, input the range as "min-max". Example: 1-5. If you want a fixed number of traits, input
          the same number for both min and max.
        </p>
          ...
          <tbody id="categoryTableBody">
            <tr class="loot-row hide">
              ...
              <td class="text-right border-0">
                <a href="#" class="btn btn-danger remove-category-button">Remove</a>
              </td>
            </tr>
    ...
    <table class="table table-sm" id="speciesTable">
      <tbody id="speciesTableBody">
        <tr class="loot-row hide">
          ...
          <td class="text-right border-0">
            <a href="#" class="btn btn-danger remove-species-button">Remove</a>
          </td>
        </tr>
    ...
    <p>
      Subtype set here cannot be inherited through a pairing using this item. If both parents have an excluded subtype, the
      pairing will have no subtype unless a default subtype is set.
    ...
    <table class="table table-sm" id="subtypeTable">
      <tbody id="subtypeTableBody">
        <tr class="loot-row hide">
          ...
          <td class="text-right border-0">
            <a href="#" class="btn btn-danger remove-subtype-button">Remove</a>
          </td>
        </tr>
