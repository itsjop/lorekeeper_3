  ...
  <tbody id="traitTableBody">
    <tr class="loot-row hide">
      <td class="loot-row-select">
        {!! Form::select('feature_id[]', $features, null, ['class' => 'form-control item-select', 'placeholder' => 'Select Trait']) !!}
      </td>
    ...
    @if ($tag->getData() != null && count($tag->getData()) > 0)
      @foreach ($tag->getData() as $feature_id)
        <tr class="loot-row">
          <td class="loot-row-select">
            {!! Form::select('feature_id[]', $features, $feature_id, ['class' => 'form-control item-select', 'placeholder' => 'Select Trait']) !!}
