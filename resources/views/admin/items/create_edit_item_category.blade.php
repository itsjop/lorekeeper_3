...
@section('admin-content')
  ...
  <div class="form-group">
    ...
    {!! Form::label('is_visible', 'Is Visible', ['class' => 'form-check-label ml-3']) !!} {!! add_help(
        'If turned off, the category will not be visible in the category list or available for selection in search. Permissioned staff will still be able to add items to them, however.'
    ) !!}
  </div>
  ...
  <div class="card mb-3" id="characterOptions">
    <div class="card-body">
      <div class="mb-2">
        <div class="form-group">
          {!! Form::checkbox('is_character_owned', 1, $category->is_character_owned, [
              'class' => 'form-check-input',
              'data-toggle' => 'toggle',
              'data-on' => 'Allow',
              'data-off' => 'Disallow'
        ...
        <div class="form-group">
          {!! Form::label('character_limit', 'Character Hold Limit') !!} {!! add_help(
              'This is the maximum amount of items from this category a character can possess. Set to 0 to allow infinite.'
          ) !!}
          {!! Form::text('character_limit', $category ? $category->character_limit : 0, [
              'class' => 'form-control stock-field',
              'data-name' => 'character_limit'
          ]) !!}
        </div>
        <div class="form-group">
          {!! Form::checkbox('can_name', 1, $category->can_name, [
              'class' => 'form-check-input',
              'data-toggle' => 'toggle',
              'data-on' => 'Allow',
              'data-off' => 'Disallow'
  ...
  @if (Config::get('lorekeeper.settings.donation_shop.item_donations') == 1 ||
          Config::get('lorekeeper.settings.donation_shop.item_donations') == 3
  )
    <div class="form-group">
      {!! Form::checkbox('can_donate', 1, $category->can_donate, [
          'class' => 'form-check-input',
          'data-toggle' => 'toggle',
          'data-on' => 'Allow',
          'data-off' => 'Disallow'
      ...
      {!! Form::checkbox('can_user_sell', 1, $category->can_user_sell, [
          'class' => 'form-check-input',
          'data-toggle' => 'toggle',
          'data-on' => 'Allow',
          'data-off' => 'Disallow'
