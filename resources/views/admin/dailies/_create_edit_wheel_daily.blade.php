...
<div class="row p-4">
  ...
  <div class="form-group col">
    {!! Form::select(
        'progress_display',
        ['none' => 'None', 'all' => 'All rewards shown'],
        $daily ? $daily->progress_display : 0,
        ['class' => 'form-control stock-field', 'data-name' => 'progress_display']
    ) !!}
    {!! Form::label('progress_display', 'Prize Display') !!} {!! add_help('Decides what kind of information on the rewards for each segment should be shown on the daily page.') !!}
  </div>
  <div class="form-group col">
    ...
    {!! Form::label('is_active', 'Set Active', ['class' => 'form-check-label ml-3']) !!} {!! add_help('If turned off, the ' . __('dailies.daily') . ' will not be visible to regular users.') !!}
  </div>
</div>
  ...
  <div class="form-group col-md-6">
    @if ($wheel?->stopper_extension)
      <a href="{{ $wheel->stopperUrl }}">
        <img
          src="{{ $wheel->stopperUrl }}"
          class="w-100 float-left mr-3"
...
<div class="row p-3">
  ...
  <div class="form-group col-lg col-6">
    {!! Form::select(
        'text_orientation',
        ['curved' => 'Curved', 'vertical' => 'Vertical'],
        $wheel->text_orientation ?? 'curved',
        ['class' => 'form-control']
    ) !!}
