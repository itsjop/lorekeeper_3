@extends('admin.layout', ['componentName' => 'admin/worldexpansion/create-edit-fauna-category'])
...
@section('admin-content')
  ...
  {!! Form::open([
      'url' => $category->id ? 'admin/world/fauna-categories/edit/' . $category->id : 'admin/world/fauna-categories/create',
      'files' => true
  ]) !!}
