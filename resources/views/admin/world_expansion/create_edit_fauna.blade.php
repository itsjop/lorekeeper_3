...
@section('admin-content')
  {!! breadcrumbs([
      'Admin Panel' => 'admin',
      'Fauna' => 'admin/world/faunas',
      ($fauna->id ? 'Save' : 'Create') . ' Fauna' => $fauna->id
          ? 'admin/world/faunas/edit/' . $fauna->id
          : 'admin/world/faunas/create'
  ]) !!}

  <h1> {{ $fauna->id ? 'Save' : 'Create' }} Fauna
    @if ($fauna->id)
      ({!! $fauna->displayName !!})
  ...
  {!! Form::open([
      'url' => $fauna->id ? 'admin/world/faunas/edit/' . $fauna->id : 'admin/world/faunas/create',
      'files' => true
  ]) !!}
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        {!! Form::select('category_id', [0 => 'Choose a Category'] + $categories, $fauna->category_id, [
  ...
  <div class="form-group">
    {!! Form::checkbox('is_active', 1, $fauna->id ? $fauna->is_active : 1, [
        'class' => 'form-check-input',
        'data-toggle' => 'toggle'
    ]) !!}
  ...
  <div class="text-right">
    {!! Form::submit($fauna->id ? 'Save' : 'Create', ['class' => 'btn btn-primary']) !!}
  </div>
