@extends('admin.layout', ['componentName' => 'admin/worldexpansion/create-edit-location-type'])
...
@section('admin-content')
  ...
  {!! Form::open([
      'url' => $type->id ? 'admin/world/location-types/edit/' . $type->id : 'admin/world/location-types/create',
      'files' => true
  ]) !!}
