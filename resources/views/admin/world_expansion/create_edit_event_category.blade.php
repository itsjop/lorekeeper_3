@extends('admin.layout', ['componentName' => 'admin/worldexpansion/create-edit-event-category'])
...
@section('admin-content')
  ...
  {!! Form::open([
      'url' => $category->id ? 'admin/world/event-categories/edit/' . $category->id : 'admin/world/event-categories/create',
      'files' => true
  ]) !!}
