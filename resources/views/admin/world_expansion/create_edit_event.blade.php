@extends('admin.layout', ['componentName' => 'admin/worldexpansion/create-edit-event'])
...
@section('admin-content')
  ...
  <div class="form-group">
    {!! Form::checkbox('is_active', 1, $event->id ? $event->is_active : 1, ['class' => 'form-check-input', 'data-bs-toggle' => 'toggle']) !!}
