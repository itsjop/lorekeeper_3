@extends('admin.layout', ['componentName' => 'admin/worldexpansion/create-edit-concept-category'])
...
@section('admin-content')
  ...
  {!! Form::open([
      'url' => $category->id ? 'admin/world/concept-categories/edit/' . $category->id : 'admin/world/concept-categories/create',
      'files' => true
  ]) !!}
