@extends('admin.layout', ['componentName' => 'admin/worldexpansion/create-edit-concept'])
...
@section('admin-content')
  ...
  {!! Form::open([
      'url' => $concept->id ? 'admin/world/concepts/edit/' . $concept->id : 'admin/world/concepts/create',
      'files' => true
  ]) !!}
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        {!! Form::select('category_id', [0 => 'Choose a Concept Category'] + $categories, $concept->category_id, [
  ...
  <div class="form-group">
    {!! Form::checkbox('is_active', 1, $concept->id ? $concept->is_active : 1, [
        'class' => 'form-check-input',
        'data-toggle' => 'toggle'
    ]) !!}
