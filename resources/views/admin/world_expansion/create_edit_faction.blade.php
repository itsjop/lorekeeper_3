@extends('admin.layout', ['componentName' => 'admin/worldexpansion/create-edit-faction'])
...
@section('admin-content')
  ...
  {!! Form::open([
      'url' => $faction->id ? 'admin/world/factions/edit/' . $faction->id : 'admin/world/factions/create',
      'files' => true
  ]) !!}
    ...
    <div class="card-body">
      <div class="row mx-0 px-0">
        ...
        @if (isset($faction->parent_id))
          <div class="form-group col-md px-0 pr-md-1">
            ...
            {!! Form::select('style', $faction->displayStyles, isset($faction->display_style) ? $faction->display_style : null, [
      ...
      <div class="row mx-0 px-0">
        <div class="form-group col-12 col-md-6 px-0 pr-md-1">
          ...
          {!! Form::select('type_id', [0 => 'Choose a Faction Type'] + $types, $faction->type_id, [
              'class' => 'form-control selectize',
              'id' => 'type'
          ]) !!}
        </div>
        ...
        <div class="form-group col-12 col-md-6 px-0 px-md-1">
          ...
          {!! Form::select(
              'parent_id',
              [0 => 'Choose a Parent'] + $factions,
              isset($faction->parent_id) ? $faction->parent_id : null,
              ['class' => 'form-control selectize']
          ) !!}
        </div>
      </div>
      ...
      @if ($user_enabled || $ch_enabled)
        <div class=" mx-0 px-0 text-center">
          @if ($user_enabled)
            {!! Form::checkbox('user_faction', 1, $faction->id ? $faction->is_user_faction : 0, [
                'class' => 'form-check-input',
                'data-toggle' => 'toggle',
                'data-on' => 'Users Can Join',
                'data-off' => 'Users Cannot Join'
            ]) !!}
          @endif
          @if ($ch_enabled)
            {!! Form::checkbox('character_faction', 1, $faction->id ? $faction->is_character_faction : 0, [
                'class' => 'form-check-input',
                'data-toggle' => 'toggle',
                'data-on' => 'Characters Can Join',
                'data-off' => 'Characters Cannot Join'
            ]) !!}
          @endif
        </div>
      @endif
                  ...
                  <div class="row">
                    <div class="col-md">
                      <div class="form-group mb-2">
                        {!! Form::label('Is Open') !!}
                        {!! Form::select('rank_is_open[]', [1 => 'Yes', 0 => 'No'], $rank->is_open, [
                            'class' => 'form-control rank-is-open',
                    ...
                    <div class="rankOpenSetting col-md-8">
                      <div class="{{ $rank->is_open ? 'show' : 'hide' }} openOptions">
                        <div class="form-group">
                          ...
                          {!! Form::number('rank_breakpoint[]', $rank->breakpoint, [
                              'class' => 'form-control',
                              'placeholder' => 'Enter a Breakpoint'
                          ]) !!}
                        </div>
                      </div>
                      <div class="{{ !$rank->is_open ? 'show' : 'hide' }} closeOptions">
                        <div class="form-group">
                          {!! Form::label('Available Positions') !!} {!! add_help(
                              'The number of positions of this rank available. Please note that reducing this will remove any existing members over the new number from their position.'
                          ) !!}
                          ...
                          <div class="col-md">
                            <div class="form-group mb-2">
                              ...
                              {!! Form::select(
                                  ...
                                  ['figure' => 'Figure'] +
                                      (Settings::get('WE_user_factions') > 0 ? ['user' => 'User'] : []) +
                                      (Settings::get('WE_character_factions') > 0 ? ['character' => 'Character'] : []),
                                  $member->member_type,
                          ...
                          <div class="rankMemberSetting col-md-8 mt-auto">
                            <div class="{{ $member->member_type == 'figure' ? 'show' : 'hide' }} figureOptions">
                              <div class="form-group">
                                {!! Form::label('Figure') !!}
                                {!! Form::select(
                                    'rank_figure_id[' . $rank->id . '][]',
                                    $figureOptions,
                                    $member->member_type == 'figure' ? $member->member_id : null,
                                    ['class' => 'form-control mr-2 selectize', 'placeholder' => 'Select Figure']
                                ) !!}
                              </div>
                            </div>
                            <div class="{{ $member->member_type == 'user' ? 'show' : 'hide' }} userOptions">
                              <div class="form-group">
                                {!! Form::label('User') !!}
                                {!! Form::select('rank_user_id[' . $rank->id . '][]', $users, $member->member_type == 'user' ? $member->member_id : null, [
                            ...
                            <div class="{{ $member->member_type == 'character' ? 'show' : 'hide' }} characterOptions">
                              <div class="form-group">
                                ...
                                {!! Form::select(
                                    'rank_character_id[' . $rank->id . '][]',
                                    $characters,
                                    $member->member_type == 'character' ? $member->member_id : null,
                                    ['class' => 'form-control mr-2 selectize', 'placeholder' => 'Select Character']
                                ) !!}
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="rank-member row">
                          ...
                          <div class="rankMemberSetting col-md-8 mt-auto">
                            ...
                            <div class="hide figureOptions">
                              <div class="form-group">
                                {!! Form::label('Figure') !!}
                                {!! Form::select('rank_figure_id[' . $rank->id . '][]', $figureOptions, null, [
                                    'class' => 'form-control mr-2 selectize',
                            ...
                            <div class="hide userOptions">
                              <div class="form-group">
                                {!! Form::label('User') !!}
                                {!! Form::select('rank_user_id[' . $rank->id . '][]', $users, null, [
                                    'class' => 'form-control mr-2 selectize',
                                    'placeholder' => 'Select User'
                                ]) !!}
                              </div>
                            ...
                            <div class="hide characterOptions">
                              <div class="form-group">
                                {!! Form::label('Character') !!}
                                {!! Form::select('rank_character_id[' . $rank->id . '][]', $characters, null, [
                                    'class' => 'form-control mr-2 selectize',
  ...
  <div class="form-group">
    {!! Form::checkbox('is_active', 1, $faction->id ? $faction->is_active : 1, [
        'class' => 'form-check-input',
        'data-toggle' => 'toggle'
    ]) !!}
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md">
            <div class="form-group mb-2">
              {!! Form::label('Is Open') !!}
              {!! Form::select('rank_is_open[]', [1 => 'Yes', 0 => 'No'], null, [
                  'class' => 'form-control rank-is-open',
                  'placeholder' => 'Choose a Setting'
              ]) !!}
            </div>
