@extends('admin.layout', ['componentName' => 'admin/worldexpansion/create-edit-flora'])
...
@section('admin-content')
  ...
  <div class="form-group">
    {!! Form::checkbox('is_active', 1, $flora->id ? $flora->is_active : 1, ['class' => 'form-check-input', 'data-bs-toggle' => 'toggle']) !!}
