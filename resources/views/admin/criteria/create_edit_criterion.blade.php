...
@section('admin-content')
  ...
  {!! Form::open([
      'url' => $criterion->id ? 'admin/data/criteria/edit/' . $criterion->id : 'admin/data/criteria/create',
      'files' => true
  ]) !!}
  ...
  <div class="row align-items-end">
    ...
    <div class="form-group col-6">
      ...
      {!! Form::select('currency_id', $currencies, $criterion->currency_id, [
  ...
  <div class="row align-items-end">
    <div class="form-group col-4">
      ...
      {!! Form::select(
          ...
          [
              ...
              'Traditional Rounding' => 'Traditional Rounding',
              'Always Rounds Up' => 'Always Rounds Up',
    ...
    <div class="form-group col-6">
      {!! Form::label('Rounding Precision') !!} {!! add_help(
          'The place value to round to, ie 1 = whole values, 2 = the nearest 10th value, 3 = the nearest 100th value, etc.'
      ) !!}
  ...
  <div class="row align-items-end">
    <div class="form-group col-4">
      {!! Form::checkbox('is_active', 1, $criterion->is_active === 1, [
    ...
    <div class="form-group col-4">
      {!! Form::checkbox('is_guide_active', 1, $criterion->is_guide_active, [
          'class' => 'form-check-input',
          'data-toggle' => 'toggle'
      ]) !!}
        ...
        <div class="card p-3 mb-2 pl-0" data-id="{{ $step->id }}">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div style="flex: 0 0 auto;">
              ...
              <button
                class="btn btn-danger delete-step"
                type="button"
                data-id="{{ $step->id }}"
              >
