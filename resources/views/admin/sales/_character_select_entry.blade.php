    ...
    <div class="row">
      ...
      <div class="col-md-10">
        <div class="form-group">
          ...
          {!! Form::select('slug[]', $characters, $character->character->slug, [
        ...
        <div class="character-details">
          ...
          <div class="saleType">
            <div class="mb-3 {{ $character->type == 'flatsale' || $character->type == 'flaffle' ? 'show' : 'hide' }} flatOptions">
              <div class="form-group">
                {!! Form::label('Price') !!}
                {!! Form::number('price[]', isset($character->data['price']) ? $character->data['price'] : null, [
                    'class' => 'form-control',
            ...
            <div class="mb-3 {{ $character->type == 'auction' ? 'show' : 'hide' }} auctionOptions">
              <div class="form-group">
                ...
                {!! Form::number('starting_bid[]', isset($character->data['starting_bid']) ? $character->data['starting_bid'] : null, [
                    'class' => 'form-control',
              ...
              <div class="form-group">
                ...
                {!! Form::number('min_increment[]', isset($character->data['min_increment']) ? $character->data['min_increment'] : null, [
                    'class' => 'form-control',
                    'placeholder' => 'Enter a Minimum Increment'
                ]) !!}
              </div>
            </div>

            <div
              class="mb-3 {{ $character->type == 'auction' || $character->type == 'xta' || $character->type == 'ota' ? 'show' : 'hide' }} xtaOptions"
            >
              <div class="form-group">
                {!! Form::label('Autobuy (Optional)') !!}
                {!! Form::number('autobuy[]', isset($character->data['autobuy']) ? $character->data['autobuy'] : null, [
                    'class' => 'form-control',
              ...
              <div class="form-group">
                ...
                {!! Form::text('end_point[]', isset($character->data['end_point']) ? $character->data['end_point'] : null, [
                    'class' => 'form-control',
            ...
            <div
              class="mb-3 {{ $character->type == 'pwyw' || $character->type == 'ota' || $character->type == 'xta' ? 'show' : 'hide' }} pwywOptions"
            >
              <div class="form-group">
                {!! Form::label('Minimum Offer (Optional)') !!}
                {!! Form::number('minimum[]', isset($character->data['minimum']) ? $character->data['minimum'] : null, [
                    'class' => 'form-control',
          ...
          <div class="form-group mt-2">
            ...
            {!! Form::text('description[]', $character->description, [
                'class' => 'form-control',
          ...
          @if ($sales->characters->count() > 1)
            <div class="form-group text-right">
              {!! Form::checkbox('character_is_open[' . $character->character->slug . ']', 1, $character->is_open, [
                  'class' => 'form-check-input',
                  'data-toggle' => 'toggle'
              ]) !!}
              {!! Form::label('character_is_open', 'Is Open', ['class' => 'form-check-label ml-3']) !!} {!! add_help(
                  'Whether or not this particular character is open or available. If the sale post itself is closed, all character sales attached will also be displayed as closed.'
              ) !!}
            </div>
          @else
