        ...
        @foreach ($areas as $area)
          <div class="d-flex row flex-wrap col-12 mt-1 pt-2 px-0 ubt-top">
            <div class="col-5 col-md-2 text-truncate">
              {!! $area->has_thumbnail ? '<img src="' . $area->thumbImageUrl . '" class="img-fluid mr-2" style="height: 2em;" />' : '' !!}{!! $area->has_image ? '<img src="' . $area->imageUrl . '" class="img-fluid mr-2" style="height: 2em;" />' : '' !!}{!! $area->name !!}
            </div>
            ...
            <div class="col-3 col-md-1 text-right">
              <a href="{{ url('admin/data/encounters/areas/edit/' . $area->id) }}" class="btn btn-primary">Edit</a>
            </div>
          </div>
        @endforeach
      </div>
