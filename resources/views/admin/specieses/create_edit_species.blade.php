...
@section('admin-content')
  ...
  <div class="form-group">
    {!! Form::label('Chance to inherit') !!} {!! add_help(
        'For pairings, how likely this species is to be passed on in percent. Must be a number between 1-100. Defaults to 50. Does not guarantee a species is inherited 100% of the time as the chances for both species are added!'
    ) !!}
