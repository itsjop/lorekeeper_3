...
@section('admin-content')
  ...
  <p> Pet drops are items that can be collected from pets at set intervals. In the code, they are called "Pet Drop Data" whereas "Pet
      ...
      @foreach ($drops as $drop)
        <div class="d-flex row flex-wrap col-12 mt-1 pt-1 px-0 ubt-top">
          ...
          <div class="col-3 col-md text-right">
            <a href="{{ $drop->url }}" class="btn btn-primary py-0"> Edit </a>
          </div>
        </div>
      @endforeach
